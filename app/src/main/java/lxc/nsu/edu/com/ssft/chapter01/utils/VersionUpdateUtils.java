...
import lxc.nsu.edu.com.ssft.HomeActivity;
import lxc.nsu.edu.com.ssft.R;
import lxc.nsu.edu.com.ssft.chapter01.entity.VersionEntity;
...
public class VersionUpdateUtils {
    ...
    public void getCloudVersion(){
        try {
            ...
            HttpGet httpGet=new HttpGet("http://100.0.101.18:8080/updateinfo.html");
    ...
    private void showUpdateDialog(final VersionEntity versionEntity){
        ...
        builder.setIcon(R.drawable.ic_001);//设置对话框图标
        //设置立即升级按钮点击事件
     ...
     * 下载新版本
     */
    protected void downloadNewApk(String apkrul){
        DownLoadUtils downLoadUtils = new DownLoadUtils();
        downLoadUtils.downapk(apkrul, "/mnt/sdcard/mobilesafe2.0.apk", new DownLoadUtils.MyCallBack() {
            @Override
